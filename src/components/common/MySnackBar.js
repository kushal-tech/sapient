...
MySnackbarContentWrapper.propTypes = {
  ...
  //</IconButton>variant: PropTypes.oneOf(["error", "info", "success", "warning"]).isRequired
};

function MySnackBar(props) {
  let { enabled, message, variant, openSnackbar } = props;
  console.log(props);
...
export default connect(null, mapDispatchToProps)(MySnackBar);
